...
/**
 * FHIR病情资源缓存实体
 * 对应数据库表: fhir_condition_cache
 *
 * @author 系统
 * @version 1.0
 */
@TableName("fhir_condition_cache")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class FhirConditionCache {
    ...
    @TableField("onset_date_time")
    private LocalDateTime onsetDateTime;

    @TableField("abatement_date_time")
    private LocalDateTime abatementDateTime;
