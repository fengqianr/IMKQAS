package com.imkqas.controller.qa;
...
public class QaController {
    ...
    @GetMapping("/intent")
    @Operation(summary = "意图分类", description = "仅执行意图路由分类（不走RAG流水线），用于意图识别准确率测试")
    public ResponseEntity<ApiResponse<Map<String, Object>>> classifyIntent(
            @Parameter(description = "用户查询文本", required = true)
