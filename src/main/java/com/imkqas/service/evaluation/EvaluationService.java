package com.imkqas.service.evaluation;

import com.imkqas.entity.evaluation.EvalRun;
...
public interface EvaluationService {
     ...
     * 分页查询某次运行的逐查询结果
     */
    com.baomidou.mybatisplus.extension.plugins.pagination.Page<com.imkqas.entity.evaluation.EvalQueryResult>
    listQueryResults(Long runId, int page, int size);

    /**
     * 查询某次运行某查询的管线快照
     */
    List<com.imkqas.entity.evaluation.EvalPipelineSnapshot> getPipelineSnapshot(Long runId, Long queryResultId);
}
