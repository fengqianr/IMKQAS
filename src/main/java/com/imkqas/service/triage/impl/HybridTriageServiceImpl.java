package com.imkqas.service.triage.impl;
...
import com.imkqas.dto.triage.BatchTriageRequest;
import com.imkqas.dto.triage.TriageRequest;
import com.imkqas.model.triage.DepartmentTriageResult;
import com.imkqas.model.triage.EmergencyCheckResult;
import com.imkqas.model.triage.TriageStats;
import com.imkqas.service.triage.TriageService;
import com.imkqas.service.triage.config.TriageConfig;
import com.imkqas.service.triage.stats.TriageStatsCollector;
...
public class HybridTriageServiceImpl implements TriageService {
    ...
    private DepartmentTriageResult fuseResults(DepartmentTriageResult ruleResult,
        ...
        // 合并推荐列表（去重，按置信度排序）
        List<com.imkqas.model.triage.DepartmentRecommendation> fusedRecommendations =
     ...
     * 合并推荐列表
     */
    private List<com.imkqas.model.triage.DepartmentRecommendation> mergeRecommendations(
            List<com.imkqas.model.triage.DepartmentRecommendation> ruleRecs,
            List<com.imkqas.model.triage.DepartmentRecommendation> llmRecs) {
        List<com.imkqas.model.triage.DepartmentRecommendation> merged = new ArrayList<>();
        ...
        // 添加LLM推荐（去重）
        if (llmRecs != null) {
            for (com.imkqas.model.triage.DepartmentRecommendation llmRec : llmRecs) {
                boolean duplicate = false;
                for (com.imkqas.model.triage.DepartmentRecommendation existing : merged) {
