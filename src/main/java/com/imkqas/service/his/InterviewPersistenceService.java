...
import com.imkqas.service.his.InterviewSession;
import com.imkqas.service.his.AnalysisResult;
import com.imkqas.service.his.TransformationPipeline;
...
public interface InterviewPersistenceService {
     ...
     */
    void saveFhirDiagnosticReport(com.imkqas.entity.his.FhirDiagnosticReportCache report);

    /**
     * 保存FHIR RiskAssessment资源
     */
    void saveFhirRiskAssessment(com.imkqas.entity.his.FhirRiskAssessmentCache risk);

    /**
     * 根据sessionId获取FHIR DiagnosticReport
     */
    Optional<com.imkqas.entity.his.FhirDiagnosticReportCache> getFhirDiagnosticReportBySession(String sessionId);

    /**
     * 根据sessionId获取FHIR RiskAssessment
     */
    Optional<com.imkqas.entity.his.FhirRiskAssessmentCache> getFhirRiskAssessmentBySession(String sessionId);
}
