...
import com.imkqas.dto.his.FhirConverter.BundleResources;
import com.imkqas.exception.BusinessException;
import com.imkqas.exception.ErrorCode;
import com.imkqas.mapper.his.*;
import com.imkqas.service.his.FhirBundleService;
    ...
    public Bundle processTransaction(Bundle bundle) {
        ...
        resources.patients.forEach(p -> {
            var existing = patientMapper.selectOne(
                    new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<com.imkqas.entity.his.FhirPatientCache>()
                            .eq(com.imkqas.entity.his.FhirPatientCache::getFhirId, p.getFhirId()));
            if (existing != null) {
        ...
        resources.observations.forEach(o -> {
            var existing = observationMapper.selectOne(
                    new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<com.imkqas.entity.his.FhirObservationCache>()
                            .eq(com.imkqas.entity.his.FhirObservationCache::getFhirId, o.getFhirId()));
            if (existing != null) {
        ...
        resources.conditions.forEach(c -> {
            var existing = conditionMapper.selectOne(
                    new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<com.imkqas.entity.his.FhirConditionCache>()
                            .eq(com.imkqas.entity.his.FhirConditionCache::getFhirId, c.getFhirId()));
            if (existing != null) {
        ...
        resources.questionnaireResponses.forEach(q -> {
            var existing = qrMapper.selectOne(
                    new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<com.imkqas.entity.his.FhirQuestionnaireResponseCache>()
                            .eq(com.imkqas.entity.his.FhirQuestionnaireResponseCache::getFhirId, q.getFhirId()));
            if (existing != null) {
