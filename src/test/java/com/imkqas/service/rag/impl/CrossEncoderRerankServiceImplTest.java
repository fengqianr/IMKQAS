...
public class CrossEncoderRerankServiceImplTest {
    ...
    void testApiKeyNotConfigured() throws IOException {
        ...
        try (MockedStatic<com.imkqas.utils.EnvUtil> envUtilMock = Mockito.mockStatic(com.imkqas.utils.EnvUtil.class)) {
            envUtilMock.when(() -> com.imkqas.utils.EnvUtil.getEnv("BAILIAN_API_KEY")).thenReturn(null);
